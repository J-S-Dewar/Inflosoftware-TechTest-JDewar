...
public class DataContext : DbContext, IDataContext
{
    ...
    protected override void OnModelCreating(ModelBuilder model)
        ...
        {
            new User { Id = 1, Forename = "Peter", Surname = "Loew", Email = "ploew@example.com", IsActive = true, DateOfBirth = null },
            new User { Id = 2, Forename = "Benjamin Franklin", Surname = "Gates", Email = "bfgates@example.com", IsActive = true, DateOfBirth = new DateTime(1997, 07, 07) },
